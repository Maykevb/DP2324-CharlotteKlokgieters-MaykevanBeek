        ...
        public void VisitBoard(SudokuGroup board, int boardIndex, SudokuGroup fullBoard)
        {
			...
			for (int i = 0; i < colLength; i++)
			{
				...
				for (int j = 0; j < colLength; j++)
				{
					...
					{
						setToFalse = CheckCol(board, colLength, i, index, setToFalse, boardIndex, fullBoard);
					}
				}
			}
		}

		private bool CheckCol(SudokuGroup board, int colLength, int i, int index, bool setToFalse, int boardIndex, SudokuGroup fullBoard)
		{
			bool stf = setToFalse;
